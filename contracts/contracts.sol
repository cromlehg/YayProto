...
contract YayProtoToken is MintableToken {	
  ...
  string public constant symbol = "YPT";
...
contract Configurator is Ownable {
  ...
  function deploy() public onlyOwner {
    ...
    presale.addMilestone(5,80);
    presale.addMilestone(5,60);
    presale.addMilestone(5,40);
    ...
    mainsale.setDevelopersTokensWallet(0x95EA6A4ec9F80436854702e5F05d238f27166A03);
    mainsale.setTeamTokensWallet(0x95EA6A4ec9F80436854702e5F05d238f27166A03);
    mainsale.setMarketingTokensWallet(0x95EA6A4ec9F80436854702e5F05d238f27166A03);
    mainsale.setAdvisorsTokensWallet(0x95EA6A4ec9F80436854702e5F05d238f27166A03);
